...
import EarningStore03 from '../../../screens/App/Earnings/Pages/EarningStore01';
...
const EarningStack = () => {
  return (
    <Stack.Navigator
        initialRouteName="EarningStore03"
        screenOptions={{
            headerShown: false
        }}
    >
        ...
        <Stack.Screen name="EarningStore03" component={EarningStore03} />
    </Stack.Navigator>
  )
}
